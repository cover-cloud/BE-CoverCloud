...
import com.covercloud.music.service.ItunesSearchService
import com.covercloud.music.service.dto.MusicResponse
import com.covercloud.music.service.dto.MusicSearchRequest
...
class MusicController(
    ...
    private val searchService: ItunesSearchService
) {
    ...
    @PostMapping("/search")
    fun search(@RequestBody request: MusicSearchRequest): List<ItunesTrackSummary> {
